...
<script type="text/javascript" src=" />"></script>
		...
		<form:form id="queryForm" class="well form-search" method="get"  modelAttribute="dressCondtions"  actioin="${ctx}/mgr/weixin/dress/index">
				<label>商家名称:</label>
...
<%-- 				<label>上映开始日期:</label>
		...
		<table class="table table-striped table-bordered table-condensed">
			    ...
			    <tbody>
    			    ...
    			    <td>
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
					            <li><a href="<%=request.getContextPath()%>/mgr/weixin/dress/${item.id }/edit"><i class="icon-edit"></i>修改</a></li>
					            <li><a href="<%=request.getContextPath()%>/mgr/weixin/dress/${item.id }/delete"><i class="icon-trash"></i>删除</a></li>
					            <li><a href="<%=request.getContextPath()%>/mgr/weixin/dress/${item.id }/get"><i class="icon-th"></i>详情</a></li>
					            <li class="divider"></li>
        			...
        			<td title="${item.dressRecommend}"><c:out value="${item.dressRecommend}"/></td>   
		...
		<div class="form-actions">
			<a href="<%=request.getContextPath()%>/mgr/weixin/dress/add" class="btn btn-primary">添加服饰资料</a>
			<a href="<%=request.getContextPath()%>/mgr/dresss/douban/index" class="btn btn-info">从豆瓣导入影片资料</a>
		</div>
	...
	function jumpPage(pageNo){
		...
		$(document).ready(function(){
			...
			$(".inbox").click(function(){
				...
				$("#dressName").html($(this).attr("title"));
